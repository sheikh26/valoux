...
public class Test {
	...
	/*
	 * public static void main(String args[]) throws Exception { String en = "1234";
	 * 
	 * String encode = encrypt(en); System.out.println("encode===" + encode); String
	 * decryptdata = decrypt(encode); System.out.println("decryptdata===" +
	 * decryptdata); }
	 */
