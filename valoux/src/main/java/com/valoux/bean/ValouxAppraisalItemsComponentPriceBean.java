...
/**
 * The persistent class for the valoux_appraisal_items_component_price database table.
 * 
 */
@Entity
@Table(name="valoux_appraisal_items_component_price")
public class ValouxAppraisalItemsComponentPriceBean implements Serializable {
	...
	@ManyToOne(fetch=FetchType.LAZY)
	@JoinColumn(name="item_component_id", nullable=false)
	private ValouxItemComponentBean valouxItemComponent;

	public ValouxAppraisalItemsComponentPriceBean() {
	}
