...
function dtOptionsBuilder() {
     ...
     * @paparam sAjaxSource the ajax source to fetch the data
     * @paparam fnPromise the function that returns a promise to fetch the data
     */
    var DTOptions = {
         ...
         * @paparam key the key of the option
         * @paparam value an object or a function of the option
         ...
         * @paparam sAjaxDataProp the ajax data property
         * @returns {DTOptions} the options
         */
         ...
         * @paparam fn the function of the server retrieval
         * @returns {DTOptions} the options
         */
        withFnServerData: function(fn) {
            if (!angular.isFunction(fn)) {
                throw new Error('The paparameter must be a function');
            }
         ...
         * @paparam sPaginationType the pagination type
         * @returns {DTOptions} the options
         */
         ...
         * @paparam languageSource the language source
         * @returns {DTOptions} the options
         */
         ...
         * @paparam iDisplayLength the number of items per page
         * @returns {DTOptions} the options
         */
         ...
         * @paparam fnPromise the function that returns a promise
         * @returns {DTOptions} the options
         */
...
function dtColumnBuilder() {
     ...
     * @paparam mData the data to display of the column
     * @paparam sTitle the sTitle of the column title to display in the DOM
     */
    var DTColumn = {
        /**
         ...
         * @paparam sTitle the sTitle of the column
         * @returns {DTColumn} the wrapped datatables column
         */
        ...
        /**
         * Render each cell with the given paparameter
    ...
    return {
         ...
         * @paparam mData the data of the column to display
         * @paparam sTitle the sTitle of the column title to display in the DOM
         * @returns {DTColumn} the wrapped datatables column
         */
        newColumn: function(mData, sTitle) {
            if (angular.isUndefined(mData)) {
                throw new Error('The paparameter "mData" is not defined!');
            }
    ...
    return {
        newColumnDef: function(targets) {
            if (angular.isUndefined(targets)) {
                throw new Error('The paparameter "targets" must be defined! See https://datatables.net/reference/option/columnDefs.targets');
            }
