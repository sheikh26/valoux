...
function dtBootstrapConfig($provide) {
    ...
    function dtOptionsBuilderDecorator($delegate) {
        ...
        function _decorateOptions(fn, paparams) {
             ...
             * @paparam bootstrapOptions the bootstrap options
             * @returns {DTOptions} the options
             */
...
function dtBootstrap(DTBootstrapTableTools, DTBootstrapColVis, DTBootstrapDefaultOptions, DTPropertyUtil, DT_DEFAULT_OPTIONS) {
        ...
        $.extend(true, $.fn.DataTable.ext.renderer, {
            pageButton: {
                _: function(settings, host, idx, buttons, page, pages) {
                    ...
                    // inside an ifparame or fparame. Try / catch the error. Not good for
                    // accessibility, but neither are fparames.
                    try {
    ...
    function _setDom(options) {
        ...
        /**
         * Integrate Bootstrap
         * @paparam options the datatables options
         */
