...
function dtPropertyUtil($q) {
     ...
     * Source is not written. It's making a fresh copy of it in order to ensure that we do not change the paparameters.
     * @paparam source the source properties to override
     * @paparam target the target properties
     ...
     * @paparam obj the object
     * @paparam propertyName the property name
     */
     ...
     * @paparam obj the object
     * @paparam excludedPropertiesName the list of properties to ignore
     ...
     * @paparam array the array containing promise or not
