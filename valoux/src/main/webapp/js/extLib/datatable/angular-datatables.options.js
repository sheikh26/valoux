...
function dtDefaultOptions() {
     ...
     * @paparam loadingTemplate the HTML to display when loading the table
     ...
     * @paparam sLanguageSource the language source
     * @returns {DTDefaultOptions} the default option config
     */
     ...
     * @paparam oLanguage the language
     * @returns {DTDefaultOptions} the default option config
     */
     ...
     * @paparam iDisplayLength the number of items to display
     * @returns {DTDefaultOptions} the default option config
     */
     ...
     * @paparam oBootstrapOptions an object containing the default options for Bootstreap integration
     * @returns {DTDefaultOptions} the default option config
     */
